...
% based only. 
settings.skipNumberOfBytes     = 0;% 215*4e6*2*2;% 1000;%7000*26000*2;

%% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode
% settings.fileName           = 'L:\AAE6102_Assignment1\Data\Urban.dat';
settings.fileName           = 'L:\AAE6102_Assignment1\Data\Opensky.bin';
...
% settings.IF                 = 0;%4.58e6e6;     % [Hz]
settings.IF                 = 4.58e6;
% settings.samplingFreq       = 26e6;%4.092e6;        % [Hz]
...
% up acquisition
settings.acqSatelliteList   = 1:50;         %[PRN numbers]
...
settings.startOffset        = 68.802;       %68.802 %[ms] Initial sign. travel time 
